...
hat_generator = SchLib(tool=SKIDL).add_parts(*[
        ...
        Part(**{ 'name':'Conn_02x38_Odd_Even', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'Conn_02x38_Odd_Even'}), 'ref_prefix':'J', 'fplist':[''], 'footprint':'Connector_AMPHENOL:AMPHENOL_MDTE_M2_Socket', 'keywords':'connector', 'description':'Generic connector, double row, 02x38, odd/even pin numbering scheme (row 1 odd numbers, row 2 even numbers), script generated (kicad-library-utils/schlib/autogen/connector/)', 'datasheet':'', 'pins':[
            Pin(num='1',name='Pin_1',func=pin_types.PASSIVE,unit=1),
            Pin(num='2',name='Pin_2',func=pin_types.PASSIVE,unit=1),
            Pin(num='3',name='Pin_3',func=pin_types.PASSIVE,unit=1),
            Pin(num='4',name='Pin_4',func=pin_types.PASSIVE,unit=1),
        ...
        Part(**{ 'name':'Conn_01x16', 'dest':TEMPLATE, 'tool':SKIDL, 'aliases':Alias({'Conn_01x16'}), 'ref_prefix':'J', 'fplist':[''], 'footprint':'Connector_FFC-FPC:FPC_16P_0.5mm', 'keywords':'connector', 'description':'Generic connector, single row, 01x16, script generated (kicad-library-utils/schlib/autogen/connector/)', 'datasheet':'', 'pins':[
            Pin(num='1',name='Pin_1',func=pin_types.PASSIVE,unit=1),
            Pin(num='2',name='Pin_2',func=pin_types.PASSIVE,unit=1),
            Pin(num='3',name='Pin_3',func=pin_types.PASSIVE,unit=1),
            Pin(num='4',name='Pin_4',func=pin_types.PASSIVE,unit=1),
