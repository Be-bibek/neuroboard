...
export function PromptBox({ onSubmitStart, className = "", autoFocus = true }: PromptBoxProps) {
  ...
  return (
    <div className={`w-full max-w-3xl bg-[#fdfdfd] dark:bg-[#252525] rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.4)] border border-gray-200 dark:border-white/10 flex flex-col overflow-hidden ${className}`}>
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            className="flex items-center gap-2 px-4 h-10 rounded-full border border-gray-200 dark:border-white/10 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors font-medium text-sm"
            onClick={() => setModelSelection(modelSelection === "Gemini 3.1 Pro" ? "GPT-4o mini" : "Gemini 3.1 Pro")}
          >
